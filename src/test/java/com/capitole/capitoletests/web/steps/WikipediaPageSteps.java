...
public class WikipediaPageSteps {
    ...
    public WikipediaPageSteps(TestContext testContext) throws Exception {
    ...
    public void theYearOfTheFirstAutomationProcessOnTheWikipediaPageShouldBe(String year) {
